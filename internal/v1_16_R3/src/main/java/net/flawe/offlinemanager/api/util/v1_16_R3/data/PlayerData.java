...
public class PlayerData extends AbstractPlayerData {
    ...
    public PlayerData(UUID uuid, Plugin plugin) {
        this(uuid, new TagCompound(((CraftServer) Bukkit.getServer()).getHandle().playerFileData.getPlayerData(uuid.toString())), plugin);
    }

    public PlayerData(UUID uuid, TagCompound compound, Plugin plugin) {
        super(uuid, compound);
        this.plugin = plugin;
        this.uuid = uuid;
